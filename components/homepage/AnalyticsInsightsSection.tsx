  ...
  return (
    <section className=" bg-gray-50 bg-cover bg-right bg-[url('/assets/decor-grid-double-big.webp')]">
      <div className="content-wrapper flex flex-col-reverse lg:flex-row gap-16 items-center">
        ...
        <div className="basis-1/2 relative lg:min-h-[600px]">
          <Image
            src="/assets/custom-img-10.jpg"
            alt="Analytics Dashboard"
            width={2000}
            height={2000}
            className="w-full object-cover lg:absolute max-w-[450px] lg:-top-10 lg:left-0 rounded-2xl shadow-xl border border-gray-200"
          />
          <Image
            ...
            width={2000}
            height={2000}
            className="w-full object-cover hidden lg:block absolute max-w-[450px] -bottom-20 right-0 rounded-2xl shadow-xl border border-gray-200"
          />
        </div>
      </div>
    </section>
