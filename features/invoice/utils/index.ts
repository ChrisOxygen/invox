...
export const createWebStyles = (theme: ColorTheme = "classic"): WebStyles => {
  ...
  return {
    ...
    logoView:
      "flex flex-col basis-[30%] items-center justify-center px-[0.625em]",
    logo: "w-[6.25em] h-[5em] object-contain",
    signatureView: "flex flex-col items-center justify-center mt-[2.5em]",
    signatureImageView:
      "flex flex-row items-center justify-between mt-[1.25em]",
    signature: "flex flex-col items-center object-contain -mb-[0.375em]",
    bodyView: "flex flex-col p-[1.875em] gap-[1.875em]",
    detailsSectionView:
      "mt-[1.875em] flex flex-row items-end justify-between gap-[2.5em]",
    invoiceToView: "flex flex-col basis-[40%] gap-[0.25em]",
    invoiceDetailsView: "flex basis-[40%] flex-col gap-[0.25em]",
    invoiceDetailsRowView:
      "flex flex-row items-center justify-between gap-[0.625em]",
    itemsTableView: "flex flex-col mt-[1.25em]",
    tableHeaderView: `flex flex-row items-center justify-between py-[0.5em] px-[0.375em]`,
    tableRowContainerView: "flex flex-col",
    tableRowView: "flex flex-row items-center justify-between py-[0.9375em]",
    termsAndTotalView: "flex flex-row items-start justify-between gap-[2.5em]",
    termsView: "flex flex-col basis-[40%] gap-[1.25em]",
    TermsRowView: "flex flex-col gap-[0.25em]",
    paymentInfoRowView: "flex-row items-start justify-between gap-[0.625em]",
    totalView: "flex flex-col basis-[40%] gap-[0.625em]",
    totalRowView: "flex flex-row items-center justify-between gap-[0.625em]",
    footerView: `flex flex-row items-center p-[1.875em] text-[0.75em] gap-[0.625em]`,
    sectionTitle: `text-[0.8125em] font-bold uppercase mb-[0.375em]`,
    clientText: "text-[0.8125em]",
    clientBusinessName: "text-[0.8125em] font-bold uppercase",
    invoiceLabel: "text-[0.8125em] font-bold uppercase",
    invoiceValue: "text-[0.8125em]",
    tableHeader: `text-[1em] font-bold uppercase`,
    itemDescription: "text-[0.8125em] basis-[50%] pl-[0.375em]",
    itemPrice: "text-[0.8125em] text-center basis-[20%]",
    itemQuantity: "text-[0.8125em] text-center basis-[10%]",
    ...
    grandTotalLabel: `text-[0.9375em] font-bold uppercase text-right basis-[60%]`,
    grandTotalValue: `text-[0.9375em] text-right font-semibold basis-[40%]`,
    divider: `w-full h-[0.0625em]`,
    itemBorder: `border-b`,
    footerText: `text-[0.8125em] font-bold`,
    footerEmail: `text-[0.8125em] pl-[0.625em] border-l`,
    footerPageNumber: "text-[0.8125em] ml-auto",
  };
};
