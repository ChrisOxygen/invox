...
const NAV: {
  ...
  { id: 'business', label: 'Business Info', hint: 'Name, address, contact', icon: Building2 },
  { id: 'branding', label: 'Branding', hint: 'Logo and brand color', icon: Palette },
  { id: 'invoice', label: 'Invoice Defaults', hint: 'Currency and numbering', icon: FileText },
  { id: 'account', label: 'Account & Security', hint: 'Password and data', icon: ShieldCheck },
]
            ...
            >
              <div className="flex items-center gap-2.5">
                <Icon
                  ...
                  style={{ color: isActive ? 'var(--blue-600)' : 'var(--ink-400)' }}
                />
